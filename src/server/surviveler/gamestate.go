...
func (gs *GameState) init(gameData *gameData) error {
	...
	txCenter = geo.Vec2{1.0, 1.0}.Div(2.0 * gs.world.GridScale)
	return nil
}
...
func (gs *GameState) createBuilding(t EntityType, pos geo.Vec2) Building {
...
func (gs *GameState) NearestEntity(pos geo.Vec2,
